...
// Golden cuckoo bird. Single flat path (from svgrepo), recolored to the
// theme gold. Inherits sizing from `className` (h-*/w-*).
export function CuckooLogo({ className }: CuckooLogoProps) {
  return (
    <svg
      viewBox="0 0 256 256"
      className={className}
